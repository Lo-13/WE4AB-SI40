...
<main class="max-w-lg mx-auto px-4 py-12">
    <a href="room-detail" class="text-gray-500 hover:text-white text-sm mb-6 inline-block">Retour au detail</a>
    <div class="bg-gray-900 rounded-2xl p-8 border border-gray-800">
        <h2 class="text-2xl font-bold mb-6">Reserver - <?php echo htmlspecialchars($room['name']); ?></h2>
        ...
        <form action="reservation?room_id=<?php echo htmlspecialchars($room['id']); ?>" method="post" class="flex flex-col gap-4">
            ...
            <div class="flex gap-4">
                <div class="flex-1">
                    <label class="text-gray-400 text-sm mb-1 block">Heure debut</label>
            ...
            <div class="bg-gray-800 rounded-xl p-4 text-sm text-gray-400">
                ...
                <p>Tarif : <span class="text-purple-400"><?php echo htmlspecialchars(number_format($room['hourly_rate'], 2)); ?> EUR / heure</span></p>
            </div>
