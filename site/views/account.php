    ...
    <main class="max-w-3xl mx-auto px-4 py-12">
        <div class="bg-gray-900 rounded-2xl p-8 border border-gray-800">
            ...
            <div class="flex flex-col gap-4 text-sm">
                        ...
                        <form method="POST" action="/account" class="flex flex-col gap-3">
                            ...
                            <select
                                ...
                                <?php foreach ($rooms as $room): ?>
                                    <option value="<?= $room->id ?>"><?= htmlspecialchars($room->name) ?>
                                    </option>
                                <?php endforeach; ?>
                ...
                <?php endif; ?>
            <div class="mt-6 pt-6 border-t border-gray-800"></div>
                <a href="/sign-out" class="block text-center bg-red-700 hover:bg-red-800 text-white py-2 rounded-lg transition">
                    Se déconnecter
                </a>
                </div>
            </div>
