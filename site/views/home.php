...
<main class="flex flex-col items-center justify-center text-center mt-28 px-4">
    ...
    <p class="text-gray-400 text-lg max-w-xl mb-10 scroll-reveal" style="transition-delay: 100ms">Salles équipées PS5, Xbox, PC pour jouer entre amis. Réservation simple et rapide.</p>
